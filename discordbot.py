...
async def on_message(message):
    ...
    if message.content == "ネコチャンバトル":
        ...
        wn2 = random.choice(("```" + message.author.name +"の選んだのは風のネコチャンだ！\n対するShinobuは……おっと不利な水のネコチャンだ！```:droplet::droplet::droplet::cat::droplet::droplet::droplet:\nチッ、お前の勝ちだよ……","```" + message.author.name +"の選んだのは風のネコチャンだ！\n対するShinobuは……おっと不利な水のネコチャンだ！```:droplet::droplet::droplet::cat::droplet::droplet::droplet:\nくそ、負けた……僕のねこが……次は勝つからな！","```" + message.author.name +"の選んだのは風のネコチャンだ！\n対するShinobuは……おっと不利な水のネコチャンだ！```:droplet::droplet::droplet::cat::droplet::droplet::droplet:\n負けた……僕のねこが……はぁ？　ふざけんなよ……","```" + message.author.name +"の選んだのは風のネコチャンだ！\n対するShinobuは……おっと不利な水のネコチャンだ！```:droplet::droplet::droplet::cat::droplet::droplet::droplet:\n負けたし……お前……イカサマしただろ！"))
