...
async def on_message(message):
    ...
    if message.content == "ネコチャンバトル":
        ...
        draw3 = random.choice(("" + message.author.name +"の選んだのは水のネコチャンだ！\n対するShinobuは……なんと！これは両者水のネコチャンだ！:droplet::droplet::droplet::cat::droplet::droplet::droplet:\nあいこじゃん。つまんねーな！もう一回やろうぜ","```ile_cat:" + message.author.name +"の選んだのは水のネコチャンだ！\n対するShinobuは……なんと！これは両者水のネコチャンだ！:droplet::droplet::droplet::cat::droplet::droplet::droplet:\n引き分け？　なかなかやるじゃん。でも僕が勝つまでやるべきだろ。","```ile_cat:" + message.author.name +"の選んだのは水のネコチャンだ！\n対するShinobuは……なんと！これは両者水のネコチャンだ！:droplet::droplet::droplet::cat::droplet::droplet::droplet:\nはいはい、引き分けね……もう僕が勝ちでもいいんじゃね？","```ile_cat:" + message.author.name +"の選んだのは水のネコチャンだ！\n対するShinobuは……なんと！これは両者水のネコチャンだ！:droplet::droplet::droplet::cat::droplet::droplet::droplet:\n引き分けかよ～。もう終わり？もうひと勝負くらいできるだろ？"))
