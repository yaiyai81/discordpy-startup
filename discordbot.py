...
async def on_message(message):
    ...
    if message.content == "ネコチャンバトル":
        ...
        draw = random.choice(("```:smile_cat:" + message.author.name +"の選んだのは火のネコチャンだ！\n:smiley_cat: 対するShinobuは……なんと！これは両者火のネコチャンだ！```:fire::fire::fire::cat::fire::fire::fire:\n引き分けか。つまんねーな……","```:smile_cat:" + message.author.name +"の選んだのは火のネコチャンだ！\n:smiley_cat: 対するShinobuは……なんと！これは両者火のネコチャンだ！```:fire::fire::fire::cat::fire::fire::fire:\n引き分け？　なかなかやるじゃん。でも僕が勝つまでやるべきだろ。","```:smile_cat:" + message.author.name +"の選んだのは火のネコチャンだ！\n:smiley_cat: 対するShinobuは……なんと！これは両者火のネコチャンだ！```:fire::fire::fire::cat::fire::fire::fire:\nはいはい、引き分けね……また勝負しろよな！","```:smile_cat:" + message.author.name +"の選んだのは火のネコチャンだ！\n:smiley_cat: 対するShinobuは……なんと！これは両者火のネコチャンだ！```:fire::fire::fire::cat::fire::fire::fire:\nあいこ～。もう終わり？もうひと勝負くらいできるだろ？"))
        draw2 = random.choice(("```:smile_cat:" + message.author.name +"の選んだのは風のネコチャンだ！\n:smiley_cat: 対するShinobuは……なんと！これは両者風のネコチャンだ！```:cloud_tornado::cloud_tornado::cloud_tornado::cat::cloud_tornado::cloud_tornado::cloud_tornado:\nあいこじゃん。つまんねーな！もう一回やろうぜ","```:smile_cat:" + message.author.name +"の選んだのは風のネコチャンだ！\n:smiley_cat: 対するShinobuは……なんと！これは両者風のネコチャンだ！```:cloud_tornado::cloud_tornado::cloud_tornado::cat::cloud_tornado::cloud_tornado::cloud_tornado:\n引き分け？　なかなかやるじゃん。でも僕が勝つまでやるべきだろ。","```:smile_cat:" + message.author.name +"の選んだのは風のネコチャンだ！\n:smiley_cat: 対するShinobuは……なんと！これは両者風のネコチャンだ！```:cloud_tornado::cloud_tornado::cloud_tornado::cat::cloud_tornado::cloud_tornado::cloud_tornado:\nはいはい、引き分けね……また勝負しろよな！","```:smile_cat:" + message.author.name +"の選んだのは風のネコチャンだ！\n:smiley_cat: 対するShinobuは……なんと！これは両者風のネコチャンだ！```:cloud_tornado::cloud_tornado::cloud_tornado::cat::cloud_tornado::cloud_tornado::cloud_tornado:\nあいこ～。もう終わり？もうひと勝負くらいできるだろ？"))
        draw3 = random.choice(("```:smile_cat:" + message.author.name +"の選んだのは水のネコチャンだ！\n:smiley_cat: 対するShinobuは……なんと！これは両者水のネコチャンだ！```:droplet::droplet::droplet::cat::droplet::droplet::droplet:\nあいこじゃん。つまんねーな！もう一回やろうぜ","```:smile_cat:" + message.author.name +"の選んだのは水のネコチャンだ！\n:smiley_cat: 対するShinobuは……なんと！これは両者水のネコチャンだ！```:droplet::droplet::droplet::cat::droplet::droplet::droplet:\n引き分け？　なかなかやるじゃん。でも僕が勝つまでやるべきだろ。","```:smile_cat:" + message.author.name +"の選んだのは水のネコチャンだ！\n:smiley_cat: 対するShinobuは……なんと！これは両者水のネコチャンだ！```:droplet::droplet::droplet::cat::droplet::droplet::droplet:\nはいはい、引き分けね……もう僕が勝ちでもいいんじゃね？","```:smile_cat:" + message.author.name +"の選んだのは水のネコチャンだ！\n:smiley_cat: 対するShinobuは……なんと！これは両者水のネコチャンだ！```:droplet::droplet::droplet::cat::droplet::droplet::droplet:\n引き分けかよ～。もう終わり？もうひと勝負くらいできるだろ？"))
